...
function getAll() {
  ...
  List.forEach(function (uye) {
    // uye değişkeni tanımladık
    html +=
      "<tr>" +
      "<th>" +
      uye.isim +
      "<th>" + // yukarıda fonksiyon içinde tanımlanan 'uye' yi push ettiğimiz değerler ile çağırırız.
      "<th>" +
      uye.soyisim +
      "<th>" + // yukarıda fonksiyon içinde tanımlanan 'uye' yi push ettiğimiz değerler ile çağırırız.
      "<th>" +
      ...
      "<th>" + // yukarıda fonksiyon içinde tanımlanan 'uye' yi push ettiğimiz değerler ile çağırırız.
      "<td>" +
      "<button class='btn btn-primary' onclick='elemanDüzenle(" +
      uye.id +
      " )' >Düzenle</button>" +
      "<button class='btn btn-danger' onclick='elemanSil(" +
      uye.id +
      " )' >Sil</button>" +
      "<td>" +
      "<tr>";
